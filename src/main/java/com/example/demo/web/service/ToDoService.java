...
public class ToDoService {
    ...
    public ToDo create(ToDoManipulationRequest request) {
        var toDoEntity = new ToDoEntity(request.getWhat(), request.isCompleted());
    ...
    private ToDo transformEntity(ToDoEntity toDoEntity) {  // Macht eine Entity in eine 'Todo' // ZURÜCKMAPPEN
        return new ToDo(
                toDoEntity.getId(),
                toDoEntity.getWhat(),
